...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-20 pb-16 px-4 sm:px-6">
      ...
      {/* Glowing Orbs */}
      <div className="absolute top-1/4 left-1/4 w-72 h-72 bg-dc-500/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-dc-600/8 rounded-full blur-[150px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full glass text-sm text-dc-300 mb-8"
        >
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-bold leading-[1.1] tracking-tight text-text-primary"
        >
        ...
        >
          ...
          <a
            href="#showcase"
            className="inline-flex items-center gap-2.5 glass hover:bg-white/10 text-text-primary px-7 py-3.5 rounded-xl text-base font-medium transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]"
          >
            <Play size={18} className="text-dc-400" />
            Watch Demo
          </a>
        </motion.div>
